...
/**
 * Service métier pour la gestion des dossiers médicaux.
...
public interface MedicalRecordService {
     ...
     * @return le dossier médical ajouté, ou null si un dossier existe déjà (cas loggué)
     */
    MedicalRecordDTO addMedicalRecord(MedicalRecordDTO dto);

    /**
     * Met à jour un dossier médical existant.
     * Le prénom et le nom servent d'identifiants uniques et ne sont pas modifiables.
     * 
     * @param dto les nouvelles données à appliquer au dossier existant
     * @return le dossier mis à jour, ou null si aucun dossier n'est trouvé (cas loggué)
     */
