...
/**
 * Interface de service pour la gestion des casernes de pompiers.
 * Fournit les opérations nécessaires à la gestion des mappages entre adresses et numéros de casernes,
 * ainsi qu'à la récupération d'informations utiles pour les services d'urgence.
 */
public interface FirestationService {

    /**
     * Récupère les personnes couvertes par une caserne donnée,
     * ainsi que le nombre d'adultes et d'enfants.
     *
     * @param stationNumber le numéro de la caserne
     * @return un objet DTO contenant les personnes couvertes et le décompte adultes/enfants
     */
    FirestationCoverageResponseDTO getPersonsCoveredByStation(int stationNumber);

    /**
     * Récupère la liste des numéros de téléphone associés aux adresses couvertes par une caserne donnée.
     *
     * @param stationNumber le numéro de la caserne
     ...
     * @throws IllegalArgumentException si aucun mappage ne correspond à l'adresse et au numéro de caserne donnés
     */
