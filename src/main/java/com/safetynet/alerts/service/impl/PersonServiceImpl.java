...
/**
 * Implementation du service metier pour la gestion des personnes. Gere les
 * opérations d'ajout, de mise à jour et de suppression.
 */
@Service
public class PersonServiceImpl implements PersonService {
	...
	public PersonDTO updatePerson(PersonDTO dto) {
		...
		Person person = personRepository.findByName(dto.getFirstName(), dto.getLastName()).orElseThrow(() -> {
